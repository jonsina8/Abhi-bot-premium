...
PICS = (environ.get('PICS', 'https://files.catbox.moe/oexxa1.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/0sxu6o.jpg")
...
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/+rDsRHXlP_IQ2NGFl'))
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '7436687322').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+rDsRHXlP_IQ2NGFl')
